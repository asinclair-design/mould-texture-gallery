  ...
  if (!item) {
    return (
      <div className="mx-auto w-[min(900px,92vw)] py-16">
        <h1 className="font-[var(--font-display)] text-3xl text-[color:var(--text)]">
          Texture not found
        </h1>
        ...
        <Link
          className="mt-6 inline-flex rounded-full border border-[var(--stroke)] bg-[var(--panel)] px-4 py-2 text-sm text-[color:var(--muted)] hover:bg-[var(--panel2)]"
          href="/"
        >
          ← Back to gallery
        </Link>
    ...
    <div className="mx-auto w-[min(1100px,92vw)] py-10 pb-24">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="mt-1 font-[var(--font-display)] text-3xl text-[color:var(--text)] md:text-4xl">
            {item.id}
          </h1>
        ...
        <div className="flex items-center gap-2">
          <Link
            className="rounded-full border border-[var(--stroke)] bg-[var(--panel)] px-4 py-2 text-sm text-[color:var(--muted)] hover:bg-[var(--panel2)]"
            href="/"
          >
            ← Gallery
          </Link>
      ...
      <div className="mt-8 overflow-hidden rounded-2xl border border-[var(--stroke)] bg-black/15">
        <img
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border border-[var(--stroke)] bg-[var(--panel)] p-4">
          <div className="text-xs font-semibold text-[color:var(--muted)]">Texture ID</div>
          <div className="mt-1 text-lg font-semibold text-[color:var(--text)]">{item.id}</div>
          <div className="mt-2 text-sm text-[color:var(--muted)]">
            This is based on the original file name.
          </div>
        </div>
        <div className="rounded-2xl border border-[var(--stroke)] bg-[var(--panel)] p-4">
          <div className="text-xs font-semibold text-[color:var(--muted)]">Series</div>
          <div className="mt-1 text-lg font-semibold text-[color:var(--text)]">{item.series}</div>
          <div className="mt-2 text-sm text-[color:var(--muted)]">
            Grouping for quick filtering in the gallery.
          </div>
        </div>
        <div className="rounded-2xl border border-[var(--stroke)] bg-[var(--panel)] p-4">
          <div className="text-xs font-semibold text-[color:var(--muted)]">Need a quote?</div>
          ...
          <a
            ...
            className="mt-3 inline-flex rounded-full border border-[var(--stroke)] bg-[var(--panel)] px-3 py-2 text-sm text-[color:var(--muted)] hover:bg-[var(--panel2)]"
          >
            Email RP Group
          </a>
        </div>
